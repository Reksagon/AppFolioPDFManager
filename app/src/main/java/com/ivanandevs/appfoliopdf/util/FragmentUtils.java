...
public class FragmentUtils {
    ...
    public String getFragmentName(Fragment fragment) {
        ...
        if (fragment instanceof ImageToPdfFragment) {
            ...
            name = fragment.getArguments() != null ?
                    fragment.getArguments().getString(Constants.BUNDLE_DATA) : null;
    ...
    private String checkViewFilesFragmentCode(Bundle arguments) {
        if (arguments != null) {
            int code = arguments.getInt(Constants.BUNDLE_DATA);
            if (code == Constants.ROTATE_PAGES) {
                return Constants.ROTATE_PAGES_KEY;
            } else if (code == Constants.ADD_WATERMARK) {
